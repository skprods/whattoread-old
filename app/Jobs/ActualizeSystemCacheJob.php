...
class ActualizeSystemCacheJob extends QueueJob
{
    public function handle()
    {
        ...
        $data = [
            ...
            'book_matches' => [
                'total' => BookRecs::query()->count(),
                'diff' => BookRecs::getDiffCount(),
            ],
            'content_frequency' => [
            ...
            'content_frequency_books' => [
                'percent' => round(($contentFrequencyBooksCount / $booksCount) * 100, 2),
            ...
            'description_frequency_books' => [
                'percent' => round(($descriptionFrequencyBooksCount / $booksCount) * 100, 2),
